...
12. 보고서 본문은 계획 → 실행 → 검토 → 개선 흐름과 육하원칙(누가·무엇을·언제·어디서·왜·어떻게·얼마나)을 갖춰 작성한다. 단, "PDCA", "Plan 단계", "Do 단계", "Check 단계", "Act 단계", "5W3H", "5W3H 기준 실행 정리" 등 프레임워크 명칭과 단계 레이블은 본문·목차·표 제목 등 결과물 어디에도 표기하지 않는다.
